...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future _getVehiclesFuture;

  Future _getUsersInfo() async {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      Container(height: widget.statusBarHeight, color: Colors.green[800]),
      Container(
          ...
          child: Column(children: [
            CarouselSlider(
              options: CarouselOptions(
                  ...
                  autoPlay: true,
                  enableInfiniteScroll: hasObtainedCards
              ...
              children: cards.map((card) {
                ...
                return Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color:
                        _current == index ? Colors.grey[700] : Colors.grey[350],
                  ),
                );
              }).toList(),
            ),
              ...
              ? TextButton.icon(
                  onPressed: () {
                    Navigator.push(context,
                        MaterialPageRoute(builder: (context) => StaysScreen()));
                  },
                ...
                ? ((_itemsCount == 0)
                    ? Center(
                        child: Column(
                            ...
                            Image(
                                image: AssetImage(
                                    'assets/images/rolling_eyes_face.png'),
                                width: MediaQuery.of(context).size.width * 0.2),
                            Padding(
                              padding: const EdgeInsets.only(top: 15.0),
                              child: Text(
                                  "Non hai ancora nessuna sosta registrata.\nEffettua la tua prima con Park+!",
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return ListTile(
                                ...
                                title: Text(lastStops[index]['vehicle']
                                        ['name'] +
                                    " il " +
                                    DateFormat('dd/MM/yyyy').format(
                                        DateTime.parse(lastStops[index]['date']
                                            .toString()
                                            .substring(0, 10)))),
                                subtitle: Text("Pagati €" +
                                    lastStops[index]['invoice']['price']
                                        .toStringAsFixed(2)),
