                        ...
                        child: Column(
                            ...
                            children: [
                              Align(
                                  ...
                                  child: Text("Stato attuale",
                                      style: TextStyle(
                                          fontWeight: FontWeight.bold,
                                          fontSize: 30,
                                          color: Colors.black))),
                              Text(
                                  "Aggiornato ogni 5 secondi, permette di avere una visuale rapida su quanti posti liberi ci sono."),
                            ]),
                      ),
                    ]),
                  ),
          ...
          child: Container(
              ...
              child: Padding(
                  ...
                  child: Center(
                    ...
                    mainAxisAlignment: MainAxisAlignment.center,
                    children: [
                      hasObtainedParkInfos
                          ? RichText(
                              text: TextSpan(children: [
                              TextSpan(
                                  text: parkInfo["free"].toString(),
                                  style: TextStyle(
                                      fontSize:
        ...
        child: hasObtainedParkInfos
            ? GridView.builder(
                ...
                itemBuilder: (BuildContext context, int index) {
                  return Container(
                    color: parkInfo["list"][index]["status"] == "free"
                        ? Colors.green
                        : (parkInfo["list"][index]["status"] == "occupied"
                            ? Colors.red
                            : Colors.blue),
                    child: Center(
                      child: Text(
                          parkInfo["list"][index]["section"] +
                              parkInfo["list"][index]["number"].toString(),
                          style: TextStyle(
                              fontWeight: FontWeight.bold,
                              fontSize:
