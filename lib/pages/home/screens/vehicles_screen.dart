                        ...
                        children: [
                          SizedBox(
                            ...
                            child: Column (
                              ...
                              children: [
                                Align(alignment: Alignment.centerLeft, child: Text("Veicoli registrati", style: TextStyle(fontWeight: FontWeight.bold, fontSize: 30, color: Colors.black))),
                                Text("Premi il pulsante a lato per aggiungere un nuovo veicolo, o scorri verso sinistra su di uno per modificarlo o eliminarlo."),
                              ]
                            ),
                          ),
                        Spacer(),
