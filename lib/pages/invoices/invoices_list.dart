...
class _InvoicesScreenState extends State<InvoicesScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
                          ...
                          child: Column(
                              ...
                              children: [
                                ...
                                Align(
                                    alignment: Alignment.centerLeft,
                                    child: Text(
                                        "Visualizza qui lo stato delle tue fatture. Fai tap su una di esse per maggiori informazioni.")),
                              ]),
                        ),
                      ]),
                    ),
                            ...
                            return ListView.builder(
                              ...
                              itemBuilder: (context, index) {
                                return ListTile(
                                  ...
                                  title: Text(invoices[index]["price"]
                                          .toStringAsFixed(2) +
                                      "€"),
                                  subtitle: Text((invoices[index]["relation"]
                                                  ["type"] ==
                                              "stop"
                                          ? "Sosta"
                                          : "Passaggio a premium") +
                                      " del " +
                                      invoices[index]["relation"]["date"] +
                                      " - #" +
                                      invoices[index]["id"].toString()),
                                  leading: ClipOval(
                                    child: Material(
                                      color: invoices[index]["status"] == "paid"
                                          ? Colors.green[800]
      ...
      floatingActionButton: unpaidTotal != 0
                ...
                return showDialog<bool>(
                  ...
                  builder: (context) {
                    return AlertDialog(
                      ...
                      content: Text(
                          'Verrà effettuato un tentativo di addebito sul tuo metodo di pagamento predefinito di ' +
