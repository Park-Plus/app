    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
            child: Column(
          children: <Widget>[
            Container(height: statusBarHeight, color: Colors.green[400]),
            Container(
                        ...
                        child: RichText(
                            ...
                            text: TextSpan(
                                children: [
                                  ...
                                  TextSpan(text: '\n'),
                                  TextSpan(
                                      text: 'Un nuovo modo per parcheggiare.',
                    ...
                    : Container(
                        ...
                        child: Row(children: [
                          ...
                          Flexible(
                            ...
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Icon(Icons.bolt, color: Colors.green[800]),
                              Padding(
                                padding: const EdgeInsets.only(top: 8.0),
                                child: Text("Tutto a colpo d'occhio",
                                    textAlign: TextAlign.center,
                                    style: TextStyle(color: Colors.grey[850])),
                              )
                            ],
                          ...
                          Flexible(
                            ...
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
                              Icon(Icons.delete, color: Colors.green[800]),
                              Padding(
                                padding: const EdgeInsets.only(top: 8.0),
                                child: Text("Mai più biglietti",
                                    textAlign: TextAlign.center,
                                    style: TextStyle(color: Colors.grey[850])),
                              )
                            ],
                      ...
                      Padding(
                        ...
                        child: FormBuilderCheckbox(
                          ...
                          validator: FormBuilderValidators.equal(
                            ...
                            true,
                            errorText:
                                'Devi accettare i termini e condizioni per poter continuare.',
                          ),
                        ),
                      ),
                      Padding(
