                      ...
                      child: Container(
                        ...
                        child: TextButton.icon(
                          ...
                          onPressed: () async {
                            ...
                            bool success = await addPaymentMethod(cardNumber, expiryDate, cardHolderName, cvvCode);
                            if(success) EasyLoading.showSuccess('Salvato!'); else EasyLoading.showError('Errore.');
      ...
      bottomNavigationBar: BottomAppBar(
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              Container(width: MediaQuery.of(context).size.width * 0.9, child: Text("I pagamenti sono processati tramite Stripe, non salviamo i tuoi dati di pagamento sui nostri database.", textAlign: TextAlign.center, style: TextStyle(color: Colors.grey[700]),))
            ],
          ),
        ),
        elevation: 0,
