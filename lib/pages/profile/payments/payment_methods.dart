                          ...
                          child: Column(
                              ...
                              children: [
                                Align(
                                    ...
                                    child: Text("Metodi di pagamento",
                                        style: TextStyle(
                                            ...
                                            color: Colors.black))),
                                Text(
                                    "Premi il pulsante a lato per aggiungere una nuova carta, o scorri verso sinistra su di una per impostarla come default o eliminarla."),
                              ]),
                        ),
                        Spacer(),
                        ClipOval(
                                  ...
                                  child: Container(
                                    ...
                                    child: ListTile(
                                      ...
                                      title: Text(paymentMethods[index]
                                              ["brand"] +
                                          " •••• " +
                                          paymentMethods[index]["last4"]),
                                      subtitle: Text("Scade il " +
                                          paymentMethods[index]["exp_month"]
                                              .toString() +
                                          "/" +
                                          paymentMethods[index]["exp_year"]
                                              .toString()),
                                      trailing: paymentMethods[index]["default"]
                                          ? Badge(
                                              toAnimate: false,
                                              shape: BadgeShape.square,
                                              badgeColor: Colors.green[800],
                                              badgeContent: Text('DEFAULT',
                                                  style: TextStyle(
                                                      color: Colors.white)),
                                            )
                                          : null,
                                          ...
                                          return showDialog<bool>(
                                            ...
                                            builder: (context) {
                                              return AlertDialog(
                                                ...
                                                content: Text(
                                                    'Vuoi rendere metodo di pagamento di default la carta ' +
