                      ...
                      child: Column(
                          ...
                          children: [
                            Align(
                                ...
                                child: Text("Le tue soste",
                                    style: TextStyle(
                                        fontWeight: FontWeight.bold,
                                        fontSize: 30,
                                        color: Colors.black))),
                            Text(
                                "Qui sotto è riportata la cronologia completa delle tue soste. Trascina verso il basso per aggiornare."),
                          ]),
                    ),
                  ),
                ),
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  return ListTile(
                                    ...
                                    title: Text(stays[index]['vehicle']
                                            ['name'] +
                                        " il " +
                                        DateFormat('dd/MM/yyyy').format(
                                            DateTime.parse(stays[index]['date']
                                                .toString()
                                                .substring(0, 10)))),
                                    subtitle: Text("Pagati €" +
                                        stays[index]['invoice']['price']
                                            .toStringAsFixed(2)),
